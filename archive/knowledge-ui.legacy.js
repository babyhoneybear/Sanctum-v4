(() => {
	...
	function getContextCollection(pageId) {
		...
		if (!current) {
			return { label: "Knowledge View", records: [] };
		}
			...
			<section class="knowledge-shell" data-page-id="${escapeHTML(pageId)}">
				<div class="knowledge-shell-head">
					<div>
						...
						<div class="knowledge-shell-subtitle">Page properties, links, and collection views.</div>
					</div>
	...
	function ensureKnowledgeDrawer() {
		...
		drawer.innerHTML = `
			<div class="knowledge-drawer-header">
				...
				<button class="knowledge-drawer-close" id="knowledgeDrawerClose" aria-label="Close knowledge">✕</button>
			</div>
